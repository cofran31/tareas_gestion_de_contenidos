...
// register meta box
function myplugin_add_meta_box_book() {

	$post_types = array( 'book', 'page' );
	...
	foreach ( $post_types as $post_type ) {
		...
		add_meta_box(
			...
			'myplugin_display_meta_box_book', // Callback function
			$post_type                   // Post type
		);
...
add_action( 'add_meta_boxes', 'myplugin_add_meta_box_book' );



// display meta box
function myplugin_display_meta_box_book( $post ) {
...
// save meta box
function myplugin_save_meta_box_book( $post_id ) {
...
add_action( 'save_post', 'myplugin_save_meta_box_book' );
